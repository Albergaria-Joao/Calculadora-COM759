<template>
  <div class="calculadora">
    ...
    <div v-on:click="logX" class="botao operadores">logₓ(y)</div>
    ...
    <div v-on:click="raizX" class="botao operadores">ʸ√</div>
    ...
    <div v-on:click="quadrado" class="botao operadores">x²</div>
    ...
    <div v-on:click="potencia" class="botao operadores">xʸ</div>
  </div>
</template>
