<template>
  <div class="calculadora">
    ...
    <div v-on:click="log" class="botao operadores" style="margin-left:20%; width:110%">log</div>
    ...
    <div v-on:click="logX" class="botao operadores" style="margin-left:20%; width:110%">logₓ(y)</div>
    ...
    <div v-on:click="raiz" class="botao operadores" style="margin-left:20%; width:110%">√</div>
    ...
    <div v-on:click="raizX" class="botao operadores" style="margin-left:20%; width:110%">ʸ√</div>
    ...
    <div v-on:click="quadrado" class="botao operadores" style="margin-left:20%; width:110%">x²</div>
    ...
    <div v-on:click="potencia" class="botao operadores" style="margin-left:20%; width:110%">xʸ</div>
  </div>
</template>
